...
docker run -d --name tpnode \
  ...
  ghcr.io/vd2org/tpnode:14.2.0_0
```

### Starting with using docker compose

```shell
curl https://raw.githubusercontent.com/vd2org/tpnode/14.2.0_0/compose.yml |
...
```shell
curl https://raw.githubusercontent.com/vd2org/tpnode/14.2.0_0/compose.yml | docker compose -p tpnode -f - up -d
```
