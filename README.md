...
docker run -d --name tpnode \
  ...
  ghcr.io/vd2org/tpnode:13.3.6_0
```

### Starting with using docker compose

```shell
curl https://raw.githubusercontent.com/vd2org/tpnode/13.3.6_0/compose.yml |
...
```shell
curl https://raw.githubusercontent.com/vd2org/tpnode/13.3.6_0/compose.yml | docker compose -p tpnode -f - up -d
```
